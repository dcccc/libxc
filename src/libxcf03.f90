...
# 1 "./libxc_inc.f90" 1
 ...
 ! regularized WB97X_RV
 integer(c_int), parameter, public :: XC_HYB_GGA_XC_WB97X_RV = 767

  ! regularized WB97M_RV
 integer(c_int), parameter, public :: XC_HYB_MGGA_XC_WB97M_RV = 768

  ! regularized B97M_RV
 integer(c_int), parameter, public :: XC_MGGA_XC_B97M_RV = 769
# 1749 "./libxc_master.F90" 2
