...
#define XC_HYB_GGA_XC_WB97X_RV 767 /* Mardirossian and Head-Gordon             */
...
gga_xc_wb97_rv_init(xc_func_type *p)
{
  assert(p->params == NULL);
  p->params = libxc_malloc(sizeof(gga_xc_wb97_params));
  xc_hyb_init_cam(p, 0.0, 0.0, 0.0);
...
extern "C"
#endif
const xc_func_info_type xc_func_info_hyb_gga_xc_wb97x_rv = {
  XC_HYB_GGA_XC_WB97X_RV,
  XC_EXCHANGE_CORRELATION,
  "wB97X-rV range-separated functional",
  XC_FAMILY_HYB_GGA,
  {&xc_ref_Mardirossian2017_35, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HYB_CAM | XC_FLAGS_VV10 | MAPLE2C_FLAGS,
  1e-14,
  {N_PAR, names, desc, par_wb97x_v, set_ext_params_cpy_cam},
  gga_xc_wb97_rv_init, NULL,
  NULL, &work_gga, NULL
};
