...
#define XC_HYB_MGGA_XC_WB97M_RV  768 /* Mardirossian and Head-Gordon */
...
static void
hyb_mgga_xc_wb97mrv_init(xc_func_type *p)
{
  assert(p->params == NULL);
  p->params = libxc_malloc(sizeof(hyb_mgga_xc_wb97_mv_params));
  xc_hyb_init_cam(p, 0.0, 0.0, 0.0);
...
extern "C"
#endif
const xc_func_info_type xc_func_info_hyb_mgga_xc_wb97m_rv = {
  XC_HYB_MGGA_XC_WB97M_RV,
  XC_EXCHANGE_CORRELATION,
  "wB97M-rV exchange-correlation functional",
  XC_FAMILY_HYB_MGGA,
  {&xc_ref_Mardirossian2017_35, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HYB_CAM | XC_FLAGS_NEEDS_TAU | XC_FLAGS_VV10 | MAPLE2C_FLAGS,
  1e-13,
  {N_PAR, names, desc, par_wb97m_v, set_ext_params_cpy_cam},
  hyb_mgga_xc_wb97mrv_init, NULL,
  NULL, NULL, &work_mgga,
};
